...
public inline fun ViewManager.rSSurfaceView(inlineOptions(InlineOption.ONLY_LOCAL_RETURN) init: android.renderscript.RSSurfaceView.() -> Unit): android.renderscript.RSSurfaceView = addView {
    ctx ->
...
public inline fun ViewManager.rSTextureView(inlineOptions(InlineOption.ONLY_LOCAL_RETURN) init: android.renderscript.RSTextureView.() -> Unit): android.renderscript.RSTextureView = addView {
    ctx ->
